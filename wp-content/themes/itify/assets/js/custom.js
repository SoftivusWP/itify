...
(function ($) {
  ...
  jQuery(document).ready(function () {
    ...
    setTimeout(() => {
      ...
      // Loop through each found anchor element
      links.forEach(function (link) {
        // Create a new button element
        var button = document.createElement('button');
        // button.addClass('navbar__dropdown-label');
        button.innerHTML = link.innerHTML;
        // button.setAttribute('class', 'navbar__dropdown-label');

        var combinedClass = (link.getAttribute('class') || '') + ' navbar__dropdown-label';
        button.setAttribute('class', combinedClass.trim());

        // button.setAttribute('class', link.getAttribute('class'));
        button.setAttribute('id', link.getAttribute('id'));
      ...
      var buttons = document.querySelectorAll('.nav-links');
      ...
      buttons.forEach(function (button) {
        ...
        button.addEventListener('click', function () {
          ...
          if (submenu) {
            submenu.classList.toggle('active'); // Toggle a class to control visibility
          }
        });
      });
    ...
    // Remove section padding in elementor
    ...
    jQuery(document).ready(function ($) {
      ...
      if ($(".offcanvas-nav").length) {
        ...
        $(".offcanvas-nav .offcanvas-menu .menu-item.menu-item-has-children button").on("click", function () {
          var $ul = $(this).next("ul");
          $(".offcanvas-nav .offcanvas-menu .menu-item.menu-item-has-children > ul").not($ul).slideUp();
          ...
          if ($(this).hasClass("active")) {
            ...
            $('.offcanvas-nav .offcanvas-menu .menu-item.menu-item-has-children button').removeClass("active");
            $(this).addClass("active");
          }
        });
