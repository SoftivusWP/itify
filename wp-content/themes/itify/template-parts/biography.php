<?php
    ...
    $author_info = get_the_author_meta( 'itify_write_by');
    $facebook_url = get_the_author_meta( 'itify_facebook' );
    $twitter_url = get_the_author_meta( 'itify_twitter' );
    $linkedin_url = get_the_author_meta( 'itify_linkedin' );
    $instagram_url = get_the_author_meta( 'itify_instagram' );
    $itify_url = get_the_author_meta( 'itify_youtube' );
    $itify_write_by = get_the_author_meta( 'itify_write_by' );
