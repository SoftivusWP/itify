...
$itify_blog_date = get_theme_mod( 'itify_blog_date', true );
$itify_blog_comments = get_theme_mod( 'itify_blog_comments', true );
$itify_blog_author = get_theme_mod( 'itify_blog_author', true );
$itify_blog_cat = get_theme_mod( 'itify_blog_cat', false );

?>


<div class="postbox__meta">
    <?php if ( !empty($itify_blog_author) ): ?>
