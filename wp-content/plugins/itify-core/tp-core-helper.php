...
include_once(TPCORE_ADDONS_DIR . '/include/custom-post-casestudy.php');
include_once(TPCORE_ADDONS_DIR . '/include/custom-post-job.php');
...
include_once(TPCORE_ADDONS_DIR . '/include/shortcode-elementor/elementor-shortcode.php');
