 ...
 * @since 1.0.0
 */
class TP_Description extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        <?php if (!empty($settings['description'])) :   ?>
            <p class="description cur-lg"><?php echo wp_kses($settings['description'], wp_kses_allowed_html('post'))  ?></p>
        <?php endif ?>
...
$widgets_manager->register(new TP_Description());
