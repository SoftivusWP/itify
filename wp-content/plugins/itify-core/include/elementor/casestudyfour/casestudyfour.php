 ...
 * @since 1.0.0
 */
class TP_Casestudyfour extends Widget_Base
{
    ...
    {
        return __('Case Study Four', 'tpcore');
    }
...
$widgets_manager->register(new TP_Casestudyfour());
