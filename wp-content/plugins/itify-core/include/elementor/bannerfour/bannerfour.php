 ...
 * @since 1.0.0
 */
class TP_Bannerfour extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Grow Your Career The Way You Feel', 'plugin-name'),
                'label_block' => true,
            ]
        );
...
?>
        ...
        <section class="career-banner fix-top  position-relative overflow-hidden">
            <div class="container">
                <div class="row justify-content-end">
                    <div class="col-12 col-lg-11">
                        <div class="row align-items-center">
                            <div class="col-12 col-sm-11 col-md-10 col-xl-8 col-xxl-9">
                                <div class="cp-banner__content">
                                    <h2 class="title mt-8 fw-7 text-xxl title-anim text-white">
                            ...
                            <?php if (!empty($settings['image']['url'])) :   ?>
                                <div class="col-12 col-sm-1 col-md-2 col-xl-4 col-xxl-3">
                                    <div class="cp-banner-thumb dir-rtl">
                                        <img src="<?php echo esc_url($settings['image']['url']) ?>" class="mh-300 unset" alt="<?php echo esc_attr('image') ?>">
                                    </div>
                                </div>
                            <?php endif ?>
                        </div>
...
$widgets_manager->register(new TP_Bannerfour());
