 ...
 * @since 1.0.0
 */
class TP_Subtitle extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        <?php if (!empty($settings['subtitle'])) :   ?>
            <h4 class="subtitle mt-8 text-secondary title-anim fw-6 mb-24"><?php echo wp_kses($settings['subtitle'], wp_kses_allowed_html('post'))  ?></h4>
        <?php endif ?>
...
$widgets_manager->register(new TP_Subtitle());
