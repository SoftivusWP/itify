...
class TpProjectPost 
{
	...
	public function register_custom_post_type() {
		...
		$labels = array(
			'name'                  => esc_html_x( 'Casestudys', 'Post Type General Name', 'tpcore' ),
			'singular_name'         => esc_html_x( 'Casestudy', 'Post Type Singular Name', 'tpcore' ),
			'menu_name'             => esc_html__( 'Casestudy', 'tpcore' ),
			'name_admin_bar'        => esc_html__( 'Casestudy', 'tpcore' ),
			...
			'add_new_item'          => esc_html__( 'Add New Casestudy', 'tpcore' ),
		...
		$args   = array(
			'label'                 => esc_html__( 'Casestudy', 'tpcore' ),
			'labels'                => $labels,
	...
	public function create_cat() {
		$labels = array(
			'name'                       => esc_html_x( 'Casestudy Categories', 'Taxonomy General Name', 'tpcore' ),
			'singular_name'              => esc_html_x( 'Casestudy Categories', 'Taxonomy Singular Name', 'tpcore' ),
			'menu_name'                  => esc_html__( 'Casestudy Categories', 'tpcore' ),
			'all_items'                  => esc_html__( 'All Casestudy Category', 'tpcore' ),
			'parent_item'                => esc_html__( 'Parent Item', 'tpcore' ),
			'parent_item_colon'          => esc_html__( 'Parent Item:', 'tpcore' ),
			'new_item_name'              => esc_html__( 'New Casestudy Category Name', 'tpcore' ),
			'add_new_item'               => esc_html__( 'Add New Casestudy Category', 'tpcore' ),
			'edit_item'                  => esc_html__( 'Edit Casestudy Category', 'tpcore' ),
			'update_item'                => esc_html__( 'Update Casestudy Category', 'tpcore' ),
			'view_item'                  => esc_html__( 'View Casestudy Category', 'tpcore' ),
			...
			'popular_items'              => esc_html__( 'Popular Casestudy Category', 'tpcore' ),
			'search_items'               => esc_html__( 'Search Casestudy Category', 'tpcore' ),
			'not_found'                  => esc_html__( 'Not Found', 'tpcore' ),
			'no_terms'                   => esc_html__( 'No Casestudy Category', 'tpcore' ),
			'items_list'                 => esc_html__( 'Casestudy Category list', 'tpcore' ),
			'items_list_navigation'      => esc_html__( 'Casestudy Category list navigation', 'tpcore' ),
		);
